...
import com.yayawan.sdk.jfsmallhelp.PersonalView;
...
public class Yayabipaydialog extends Basedialogview implements
	...
	private PersonalView mPersionview;
	...
	public Yayabipaydialog(Activity activity) {
		super(activity);
		// TODO Auto-generated constructor stub
	}
	
	public Yayabipaydialog(Activity activity,PersonalView mpersionalview) {
		super(activity);
		mPersionview=mpersionalview;
		// TODO Auto-generated constructor stub
	}
	...
	public void createDialog(final Activity mActivity) {
		...
		et_mMoney = machineFactory.MachineEditText(et_mMoney, 0, MATCH_PARENT,
				1, "请选择充值面额", 28, mLinearLayout, 0, 6, 0, 0);
	...
	private void initlogic() {
		...
		mPaynow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        ...
		        order2.orderId = System.currentTimeMillis()/1000+"";
		        order2.goods = "丫丫币";
		        order2.money = Long.parseLong(mCurrentMoney+"00");
		        order2.ext = "910";
		        order2.paytype=1;
		        YayaWan.payment(mActivity, order2,false, new YayaWanPaymentCallback() {
...
//		                    System.out.println("进来了dialogdismiss");
//		                   
//		                }
		            }
