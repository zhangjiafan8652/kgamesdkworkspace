...
import com.yayawan.sdk.base.ResultCode;
...
import com.yayawan.sdk.jfxml.Alipay_paymentxml;
...
public class Payment_jf extends BaseView implements YayaWanPaymentCallback {
	...
	public void logic() {
		...
		mCallback = YayaWan.mCallback;
		// mPaymentCallback = (YayaWanPaymentCallback) getIntent()
		// .getSerializableExtra("callback");
		mOrder = YayaWan.mPayOrder;
	...
	private void getbill() {
		...
		new Thread() {
			...
			public void run() {
				try {
					Thread.sleep(6 * 1000);
					mBillResult = ObtainData.getBillResult(mContext,
