...
import com.yayawan.sdk.jfpay.Payment_jf;
import com.yayawan.sdk.jfpay.Yayapaymain_jf;
import com.yayawan.sdk.jfpay.Yinlian;
import com.yayawan.sdk.jfsmallhelp.Personal_dialog_ho;
import com.yayawan.sdk.jfutils.Yayalog;
import com.yayawan.sdk.util.SystemUiHider;
...
public class BaseLogin_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		case ViewConstants.YINLIANPAY_ACTIVITY:
			...
			break;
		/*
		 * case ViewConstants.RESETPASSWORD: mBaseview = new
		 * ResetPassword_jf(this); setContentView(mBaseview.getView()); break;
		 */
