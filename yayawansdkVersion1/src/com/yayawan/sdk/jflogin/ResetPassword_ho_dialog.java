		...
		public void handleMessage(Message msg) {
			...
			case AUTHCODE:
				...
				/*if (mCodeCountDown == null) {
					mCodeCountDown = mCodeCountDown = new CodeCountDown(60000,1000,
							bt_mGetsecurity);
				}*/
			...
			public void onClick(View v) {
				...
				if ("".equals(mUserName) || mUserName.length() < 0) {
					...
					new Thread() {
						...
						public void run() {
							try {
								mResult = ObtainData.resetPassword(mActivity,
										mUserName, mCode, mNewPassword);
