		...
		httpUtil.send(HttpMethod.POST, ViewConstants.unionmakeorder,
				requestParams, new RequestCallBack<String>() {
					...
					public void onSuccess(final ResponseInfo<String> arg0) {
						...
						disprogress();
						try {
							System.out.println("支付回来的结果" + arg0.result);

							final JSONObject json = new JSONObject(arg0.result);

							int success = json.getInt("err_code");
										...
										.post(new Runnable() {
											...
											public void run() {
											    ...
											    try {
													...
													String orderid=info.getString("id");
													String url_params=info.getString("url_params");
													pay_run(paramActivity,orderid,url_params);
...
private void pay_run(final Activity paramActivity, String orderid2, String url_params2) {

		
		
		String goodsTokenUrl =url_params2;
