...
public class Shengda_help_dialog extends Basedialogview {

	public Shengda_help_dialog(Activity activity) {
		super(activity);
	}
	...
	public void createDialog(Activity mActivity) {
		...
		machineFactory.MachineView(ll_content, 650, 650, "LinearLayout");
		...
		machineFactory.MachineTextView(chongzhihelp1, MATCH_PARENT,
				WRAP_CONTENT, 0, Utilsjf.ToDBC(StringConstants.SHENGDA_HELP1), 28,
