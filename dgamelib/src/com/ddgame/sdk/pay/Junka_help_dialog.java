...
public class Junka_help_dialog extends Basedialogview {

	public Junka_help_dialog(Activity activity) {
		super(activity);
	}
	...
	public void createDialog(Activity mActivity) {
		...
		machineFactory.MachineTextView(chongzhihelp1, MATCH_PARENT,
				WRAP_CONTENT, 0, StringConstants.JUNKA_HELP1, 28,
