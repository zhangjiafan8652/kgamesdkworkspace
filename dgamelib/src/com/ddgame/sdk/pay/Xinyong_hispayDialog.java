...
import com.ddgame.sdk.bean.BankInfo;
...
public class Xinyong_hispayDialog extends Basedialogview implements
	...
	public Xinyong_hispayDialog(Activity activity) {
		super(activity);
	}
	...
	public void createDialog(final Activity mActivity) {
		...
		machineFactory.MachineView(ll_content, 650, 650, 0, "LinearLayout", 20,
				20, 20, 0, 100);
	...
	private void initlogic() {
		...
		bankInfo.bank_id = "1111";
		bankInfo.bankname = "工商银行";
		bankInfo.lastno = "688";
		bankInfo.bindvalid = "222";
		bankInfo.id = "222";
		BankInfo bankInfo2 = new BankInfo();
		bankInfo2.bank_id = "1111";
		bankInfo2.bankname = "中信银行";
		bankInfo2.lastno = "688";
		bankInfo2.bindvalid = "222";
		bankInfo2.id = "222";
		 mBankList = new ArrayList<BankInfo>();
		mBankList.add(bankInfo);
		mBankList.add(bankInfo);
		mBankList.add(bankInfo);
		*/
		ll_secondpay.setVisibility(View.VISIBLE);

		MoneyListAdapter_jf bankAdapter = new MoneyListAdapter_jf();
		mGridView.setAdapter(bankAdapter);
		// mGridView.setSelection(0);
		// mBank = AgentApp.mUser.banks.get(0);
		if (mBankList.size() < 3) {
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				selectpostion = position;
				 mBank = AgentApp.mUser.banks.get(position);
			}
		});
		...
		iv_mOther.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				XinyongkapayDialog xinyongkapayDialog = new XinyongkapayDialog(
						mActivity);
				xinyongkapayDialog.dialogShow();
			}
		});
