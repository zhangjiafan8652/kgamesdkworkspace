...
import com.ddgame.sdk.xml.Yinlianpay_xml_po;
			...
			case BILLRESULT:
				...
				if (mBillResult != null) {
					if (mBillResult.success == 1) {
						// 第二次确认操作失败
						if (DgameSdk.mPaymentCallback!=null) {
							DgameSdk.mPaymentCallback.onError(0);
							DgameSdk.mPaymentCallback=null;
						}
						...
						if (DgameSdk.mPaymentCallback!=null) {
							DgameSdk.mPaymentCallback.onSuccess(AgentApp.mUser, AgentApp.mPayOrder, 1);
							DgameSdk.mPaymentCallback=null;
						}
						// 支付操作成功等待到账
