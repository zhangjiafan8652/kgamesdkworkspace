...
public class Showgiftcode_dialog extends Basedialogview {
	...
	public void createDialog(final Activity mActivity) {
		...
		machineFactory.MachineTextView(tv_zhuce, MATCH_PARENT, MATCH_PARENT, 0,
				"激活码领取", 38, mLinearLayout, 0, 0, 0, 0);
		...
		machineFactory.MachineTextView(tv_text1, MATCH_PARENT, WRAP_CONTENT, 0,
				"  激活码(长按激活码即可复制):", 27, mLinearLayout, 0, 10, 0, 0);
		tv_text1.setTextColor(Color.BLACK);

		tv_mDescription = new EditText(mContext);
		...
		tv_mDescription.setBackgroundDrawable(null);
		...
		bt_mOk = machineFactory.MachineButton(bt_mOk, 0, MATCH_PARENT, 1,
				"复制激活码", 30, mLinearLayout, 0, 0, 0, 0);
	...
	public void setTv_mDescription(EditText tv_mDescription) {
