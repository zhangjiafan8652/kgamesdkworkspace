...
public class Yinlianpay_xml_po extends Basexml implements Layoutxml {
	...
	public Yinlianpay_xml_po(Activity activity) {
		super(activity);
	...
	public View initViewxml() {
		...
		machineFactory.MachineView(pb_mLoading, 50, 50, 0, mRelativeLayout, 0,
		...
		machineFactory.MachineView(wv_mWeiboview, ViewConstants.getHoldActivityWith(mContext), ViewConstants.getHoldActivityHeight(mContext)-96,
				mLinearLayout);
